      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI & BACKEND</h3>
              <h4>Machine Learning & Server Architecture</h4>
              <p>
                Building intelligent models and robust APIs. From AI predictive maintenance to medical report analysis with ML algorithms.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
